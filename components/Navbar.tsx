        ...
        <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
          ...
          <div className="flex space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
            ...
            <button
              type="button"
              onClick={toggleMenu}
              className="inline-flex size-10 items-center justify-center rounded-lg border-2 border-blue-600 p-2 text-sm bg-blue-600 text-white focus:outline-none focus:ring-2 dark:text-blue-600 dark:hover:bg-gray-700 dark:focus:ring-gray-600 md:hidden"
